...
"""BLEU score implementation. from nltk.translate.bleu_score, nltk version: 3.3 or 3.4"""
...
def sentence_bleu(references, hypothesis, weights=(0.25, 0.25, 0.25, 0.25),
                  smoothing_function=None, auto_reweigh=True):
    """
...
def corpus_bleu(list_of_references, hypotheses, weights=(0.25, 0.25, 0.25, 0.25),
    ...
    if auto_reweigh:
        if hyp_lengths < 4 and tuple(weights) == (0.25, 0.25, 0.25, 0.25):
